...
从 SharePoint Framework v1.10 版开始，您可以将 SharePoint Framework web 部件用作个人 Microsoft Teams 应用程序。这可以通过在 supportedHosts 值中包含“ **TeamsPersonalApp** ”来控制。个人应用程序 SPFx web 部件没有配置选项。
